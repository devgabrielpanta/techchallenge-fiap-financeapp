...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants: Record<string, string> = {
    ...
    outline:
      "border border-[var(--color-primary)] text-[var(--color-primary)] hover:bg-[var(--color-primary)] hover:text-[var(--color-white)] focus:ring-[var(--color-primary)]",
    ghost:
      "bg-transparent text-[var(--color-primary)] hover:bg-[var(--color-primary)] hover:text-[var(--color-white)] focus:ring-[var(--color-primary)]",
  };
