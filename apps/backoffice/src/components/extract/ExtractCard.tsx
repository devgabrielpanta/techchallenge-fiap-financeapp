...
export default function ExtractCard({
  ...
  return (
    <li
      key={transaction.id}
      className="group flex flex-col p-3 hover:rounded-md hover:bg-[var(--color-primary)] hover:text-[var(--color-white)] transition-colors border-b border-[var(--color-border)] pb-1 cursor-pointer"
